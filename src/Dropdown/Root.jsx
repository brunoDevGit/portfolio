...
export function DropdownRoot() {
    ...
    const cachedOption = useMemo(() =>
        getOptionById(cachedId), [cachedId, getOptionById,])
    ...
    return (
        <div style={{ perspective: 2000 }}>
            <motion.div
                ...
                transition={{
                    opacity: { duration: refDuration, delay: 0.1 },
                    rotateX: { duration: refDuration, delay: 0.1 },
                }}
            >
                <motion.div
                    ...
                    transition={{
                        ...
                        x: isFirstInteraction ?
                            { duration: 0 } : refDuration,
                        width: {
                            duration:
                                isFirstInteraction ? 0 : refDuration * 0.93
                        },
                        height: {
                            duration:
                                isFirstInteraction ? 0 : refDuration * 0.93
...
function DropdownArrow({ isFirstInteraction }) {
    ...
    return (
        <motion.div className="dropdown-arrow"
            initial={{
                opacity: 0,
            }}
            animate={{
