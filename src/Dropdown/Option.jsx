...
export function DropdownOption({ 
  name, content: Content, backgroundHeight }) {
  ...
  useEffect(() => {
    if(!registered && optionDimensions) {
      ...
      registerOption({
        ...
        optionDimensions,
        optionCenterX: 
        optionDimensions.x + optionDimensions.width / 2,
        WrappedContent, backgroundHeight,
      })
      setRegistered( true )
  ...
  }, [registerOption, id, registered,
     optionDimensions, updateOptionProps,
    deleteOptionById,backgroundHeight])
